...
export default function OurStory() {
  return (
    <div className="our-story-page" style={{ backgroundColor: 'var(--bg-main)', minHeight: '100vh', padding: '0 0 5rem' }}>
              ...
              {[
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                    ...
                    <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: 'var(--primary-dark)' }} />
                  </div>
                  <h4 style={{ fontSize: '1rem', fontWeight: '850', color: 'var(--primary-dark)', margin: '0 0 0.5rem 0' }}>{milestone.title}</h4>
      ...
      <section style={{ backgroundColor: '#FFFFFF', padding: '6rem 0', borderTop: '1.5px solid var(--border-color)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
          
          <div style={{ textAlign: 'center', marginBottom: '4rem', maxWidth: '600px', margin: '0 auto 4rem' }}>
            <h2 style={{ fontSize: '2.25rem', fontFamily: 'var(--font-serif)', color: 'var(--primary-dark)', fontWeight: '800', marginBottom: '0.75rem' }}>
            ...
            {[
              ...
              <div 
                ...
                style={{ 
                  ...
                  borderRadius: '24px', 
                  border: '1.5px solid var(--border-color)',
                  boxShadow: '0 8px 25px rgba(56, 20, 35, 0.01)',
                ...
                onMouseOut={(e) => e.currentTarget.style.transform = 'none'}
              >
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: '#FFFFFF', color: 'var(--accent-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--border-color)' }}>
                  {card.icon}
                </div>
                <span style={{ position: 'absolute', top: '2rem', right: '2rem', fontSize: '1.25rem', fontWeight: '900', color: 'rgba(56, 20, 35, 0.1)' }}>{card.num}</span>
                <h3 style={{ fontSize: '1.2rem', fontFamily: 'var(--font-serif)', color: 'var(--primary-dark)', fontWeight: '800', marginBottom: '0.75rem', margin: 0 }}>{card.title}</h3>
      ...
      <section style={{ backgroundColor: '#FBF8F2', padding: '6rem 0', borderTop: '1.5px solid var(--border-color)', borderBottom: '1.5px solid var(--border-color)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <h2 style={{ fontSize: '2.25rem', fontFamily: 'var(--font-serif)', color: 'var(--primary-dark)', fontWeight: '800', marginBottom: '0.5rem' }}>Our Non-Negotiables</h2>
            <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', fontWeight: '600' }}>The guidelines behind every single MILASTY bake.</p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            
            <div className="glass-card" style={{ padding: '2.25rem 2rem', backgroundColor: '#FFFFFF', borderRadius: '20px', border: '1.5px solid var(--border-color)', transition: 'transform 0.2s' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-3px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'none'}>
              <span style={{ fontSize: '0.8rem', fontWeight: '800', color: 'var(--accent-gold)', display: 'block', marginBottom: '0.75rem' }}>01</span>
              <h3 style={{ fontSize: '1.15rem', fontWeight: '850', color: 'var(--primary-dark)', marginBottom: '0.75rem', margin: 0 }}>Zero Palm Oil</h3>
            ...
            <div className="glass-card" style={{ padding: '2.25rem 2rem', backgroundColor: '#FFFFFF', borderRadius: '20px', border: '1.5px solid var(--border-color)', transition: 'transform 0.2s' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-3px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'none'}>
              ...
              <h3 style={{ fontSize: '1.15rem', fontWeight: '850', color: 'var(--primary-dark)', marginBottom: '0.75rem', margin: 0 }}>Unrefined Jaggery</h3>
              <p style={{ fontSize: '0.88rem', color: 'var(--text-muted)', lineHeight: '1.65', margin: 0, fontWeight: '500' }}>
            ...
            <div className="glass-card" style={{ padding: '2.25rem 2rem', backgroundColor: '#FFFFFF', borderRadius: '20px', border: '1.5px solid var(--border-color)', transition: 'transform 0.2s' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-3px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'none'}>
              ...
              <h3 style={{ fontSize: '1.15rem', fontWeight: '850', color: 'var(--primary-dark)', marginBottom: '0.75rem', margin: 0 }}>Zero Preservatives</h3>
              <p style={{ fontSize: '0.88rem', color: 'var(--text-muted)', lineHeight: '1.65', margin: 0, fontWeight: '500' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem' }}>
            {[
              ...
              { name: 'JAGGERY', type: 'Organic Sweetness', desc: 'Unrefined sweetener rich in minerals, containing zero chemicals.', img: 'https://images.unsplash.com/photo-1596450514735-2410277f6b98?auto=format&fit=crop&w=300&q=80' },
            ].map((ingredient) => (
              <div key={ingredient.name} style={{ textAlign: 'center' }}>
                <img 
                  src={ingredient.img} 
                  alt={ingredient.name} 
                  style={{ width: '120px', height: '120px', borderRadius: '50%', objectFit: 'cover', border: '1.5px solid var(--border-color)', margin: '0 auto 1.25rem', display: 'block', boxShadow: 'var(--shadow-sm)' }} 
                />
                <h4 style={{ fontSize: '0.98rem', fontWeight: '850', color: 'var(--primary-dark)', margin: '0 0 0.15rem 0' }}>{ingredient.name}</h4>
