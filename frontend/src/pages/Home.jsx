  ...
  return (
    <div ref={homeRef} className="home-page" style={{ backgroundColor: 'transparent', position: 'relative' }}>
      ...
      <div className="home-content" style={{ position: 'relative', zIndex: 3 }}>
        ...
        {/* ================================================================== */}
        {/* UNIFIED PREMIUM CUSTOMER TESTIMONIAL PANEL                         */}
        {/* ================================================================== */}
        <section 
          ref={customerTestimonialRef} 
          className="reveal-fade-up unified-testimonials-section" 
          style={{ 
            padding: isMobile ? '2.5rem 0' : '5rem 0', 
            backgroundColor: 'transparent', 
            borderBottom: '1px solid rgba(255, 255, 255, 0.15)' 
          }}
        >
          <div className="container" style={{ maxWidth: '1240px', margin: '0 auto', padding: isMobile ? '0 1rem' : '0 1.5rem' }}>
            
            {/* Shared Outer Panel Container */}
            <div
              className="glass-card unified-testimonials-container"
              style={{
                backgroundColor: 'rgba(30, 16, 9, 0.72)',
                backdropFilter: 'blur(24px)',
                WebkitBackdropFilter: 'blur(24px)',
                borderRadius: isMobile ? '28px' : '36px',
                border: '1px solid rgba(185, 205, 148, 0.35)',
                boxShadow: 'inset 0 1px 1px rgba(255, 255, 255, 0.1), 0 20px 50px rgba(0, 0, 0, 0.5)',
                padding: isMobile ? '2.25rem 1.25rem' : '4.5rem 3.5rem',
                position: 'relative',
                overflow: 'hidden',
                boxSizing: 'border-box'
              }}
            >
              ...
              <div style={{ position: 'absolute', top: 0, left: 0, width: '120px', height: '120px', background: 'radial-gradient(circle at top left, rgba(185, 205, 148, 0.15), transparent 70%)', pointerEvents: 'none' }} />
              <div style={{ position: 'absolute', bottom: 0, right: 0, width: '120px', height: '120px', background: 'radial-gradient(circle at bottom right, rgba(185, 205, 148, 0.15), transparent 70%)', pointerEvents: 'none' }} />

              {/* ------------------------------------------------------------- */}
              {/* SECTION 1: CUSTOMER LOVE                                      */}
              {/* ------------------------------------------------------------- */}
              <div 
                className="testimonial-part-1"
              ...
              >
                {/* Header 1 */}
                <div style={{ textAlign: 'center', maxWidth: '660px', margin: isMobile ? '0 auto 1.75rem' : '0 auto 3rem' }}>
                  <span style={{ display: 'inline-block', marginBottom: '0.5rem', fontSize: '0.82rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--accent-gold)', fontWeight: '800' }}>
                    CUSTOMER LOVE
                  </span>
                  <h2 style={{ fontSize: isMobile ? '2rem' : '2.6rem', color: '#FFFDF9', fontFamily: 'var(--font-serif)', fontWeight: '800', lineHeight: '1.25', margin: '0 0 0.75rem' }}>
                    What Our Customers <span style={{ color: 'var(--accent-gold)' }}>Really Say.</span>
                  </h2>
                  <p style={{ color: 'rgba(255, 255, 255, 0.85)', fontSize: isMobile ? '0.9rem' : '1.02rem', lineHeight: '1.6', margin: 0, fontWeight: '500' }}>
                  ...
                  <div style={{ width: '100%', boxSizing: 'border-box' }}>
                    {activeTestimonials[activeTestimonialIdx] && (
                      ...
                      >
                        <Quote 
                          size={70} 
                          style={{ position: 'absolute', top: '10px', right: '12px', color: 'rgba(200, 155, 60, 0.08)', pointerEvents: 'none' }} 
                        />
                        ...
                        <div style={{ position: 'relative', zIndex: 2 }}>
                          <div style={{ display: 'flex', gap: '3px', color: 'var(--accent-gold)', marginBottom: '0.85rem' }}>
                          ...
                          <p style={{ fontSize: '0.92rem', fontFamily: 'var(--font-serif)', fontStyle: 'italic', color: '#FFFDF9', lineHeight: '1.6', marginBottom: '1.25rem', fontWeight: '500' }}>
                            "{activeTestimonials[activeTestimonialIdx].review}"
                          </p>

                          <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.15)', paddingTop: '0.85rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
                              ...
                              <div>
                                <strong style={{ fontSize: '0.88rem', color: '#FFFDF9', display: 'block', fontWeight: '850', margin: 0 }}>
                                  {activeTestimonials[activeTestimonialIdx].customerName}
                                </strong>
                                <span style={{ fontSize: '0.72rem', color: '#b9cd94', fontWeight: '700', display: 'inline-flex', alignItems: 'center', gap: '0.2rem' }}>
                            ...
                            {activeTestimonials[activeTestimonialIdx].product && (
                              <span style={{ fontSize: '0.68rem', color: 'rgba(255, 255, 255, 0.85)', backgroundColor: 'rgba(255, 255, 255, 0.08)', border: '1px solid rgba(255, 255, 255, 0.2)', padding: '0.2rem 0.5rem', borderRadius: '6px', fontWeight: '600' }}>
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            padding: isActiveCenter ? '2rem 1.75rem' : '1.75rem 1.4rem',
                            transform: isActiveCenter ? 'scale(1.02)' : 'scale(0.98)',
                        ...
                        >
                          ...
                          <div style={{ position: 'relative', zIndex: 2 }}>
                            <div style={{ display: 'flex', gap: '4px', color: 'var(--accent-gold)', marginBottom: '1rem' }}>
                              {[...Array(item.rating || 5)].map((_, i) => (
                                <Star key={i} size={16} fill="var(--accent-gold)" color="var(--accent-gold)" />
                              ))}
                            </div>

                            <p style={{ fontSize: isActiveCenter ? '1rem' : '0.92rem', fontFamily: 'var(--font-serif)', fontStyle: 'italic', color: '#FFFDF9', lineHeight: '1.6', marginBottom: '1.75rem', fontWeight: '500' }}>
                              "{item.review}"
                            </p>
                          </div>

                          <div style={{ position: 'relative', zIndex: 2, borderTop: '1px solid rgba(255, 255, 255, 0.15)', paddingTop: '1rem' }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                {item.avatar && (
                                  <img 
                                    ...
                                    style={{ width: '40px', height: '40px', borderRadius: '50%', objectFit: 'cover', border: isActiveCenter ? '1.5px solid var(--accent-gold)' : '1px solid rgba(255, 255, 255, 0.3)' }}
                                  />
                                )}
                                <div>
                                  <strong style={{ fontSize: '0.95rem', color: '#FFFDF9', display: 'block', fontWeight: '850' }}>
                                    {item.customerName}
                                  </strong>
                                  <span style={{ fontSize: '0.75rem', color: '#b9cd94', fontWeight: '700', display: 'inline-flex', alignItems: 'center', gap: '0.2rem' }}>
                                    <CheckCircle2 size={12} color="#b9cd94" />
                                    {item.customerRole}
                                  </span>
                                </div>
                            ...
                            {item.product && (
                              <div style={{ marginTop: '0.5rem' }}>
                                <span style={{ fontSize: '0.72rem', color: 'rgba(255, 255, 255, 0.85)', backgroundColor: 'rgba(255, 255, 255, 0.08)', border: '1px solid rgba(255, 255, 255, 0.2)', padding: '0.25rem 0.55rem', borderRadius: '6px', fontWeight: '600' }}>
                                  Tried: {item.product}
                                </span>
                              </div>
                            )}
                ...
                {/* Section 1 Controls: Dots + Arrows */}
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.85rem', marginTop: isMobile ? '1.25rem' : '2rem' }}>
              ...
              <div 
                style={{ 
                  margin: isMobile ? '2.25rem 0' : '3.5rem 0', 
                  display: 'flex', 
                  alignItems: 'center', 
                  justifyContent: 'center',
                  gap: '1.25rem',
              ...
              >
                <div style={{ flex: 1, height: '1px', background: 'linear-gradient(90deg, transparent, rgba(185, 205, 148, 0.35), transparent)' }} />
                <span style={{ fontSize: '0.78rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--accent-gold)', fontWeight: '800', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', whiteSpace: 'nowrap' }}>
              ...
              {/* ------------------------------------------------------------- */}
              {/* SECTION 2: LOVED BY HEALTH-CONSCIOUS HOMES                   */}
              {/* ------------------------------------------------------------- */}
              <div 
                ref={reviewRef}
                className="testimonial-part-2"
              ...
              >
                {/* Header 2 */}
                <div style={{ textAlign: 'center', maxWidth: '600px', margin: isMobile ? '0 auto 1.75rem' : '0 auto 3rem' }}>
                  <span style={{ display: 'inline-block', marginBottom: '0.5rem', fontSize: '0.82rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--accent-gold)', fontWeight: '800' }}>
                    CUSTOMER STORIES
                  </span>
                  <h2 style={{ fontSize: isMobile ? '1.9rem' : '2.6rem', color: '#FFFDF9', fontFamily: 'var(--font-serif)', fontWeight: '800', lineHeight: '1.25', margin: 0 }}>
                ...
                {isMobile ? (
                  ...
                  <div style={{ width: '100%', boxSizing: 'border-box' }}>
                    {reviews[carouselIndex % reviews.length] && (
                      ...
                      >
                        <div>
                          <div style={{ display: 'flex', gap: '3px', color: '#b9cd94', marginBottom: '0.85rem' }}>
                        ...
                        <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.12)', paddingTop: '0.75rem' }}>
                          <strong style={{ fontSize: '0.9rem', color: '#FFFDF9', display: 'block', marginBottom: '0.15rem', fontWeight: '850' }}>
                            {reviews[carouselIndex % reviews.length].name}
                          </strong>
                          <span style={{ fontSize: '0.74rem', color: '#b9cd94', fontWeight: '700' }}>
                        ...
                        >
                          ...
                          >
                            <div>
                              ...
                              <p style={{ fontSize: '0.98rem', fontFamily: 'var(--font-serif)', fontStyle: 'italic', color: '#FFFDF9', lineHeight: '1.6', marginBottom: '1.5rem', fontWeight: '500' }}>
                                "{rev.quote}"
                              </p>
                            </div>
                ...
                {/* Section 2 Controls: Dots + Arrows */}
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.85rem', marginTop: isMobile ? '1.25rem' : '2rem' }}>
                  <div style={{ display: 'flex', gap: '0.45rem' }}>
                    {reviews.map((_, idx) => {
